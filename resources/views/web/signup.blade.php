    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                <form class="login100-form validate-form" action="{{ route('web_sign_up') }}" target="_self"
                      method="POST">
                    @csrf
                    ...
                    <div class="container-login100-form-btn m-t-20">
                        <button class="login100-form-btn" type="submit" style="background: #34ce57; color: #1d2124;">
                            ثبت نام
                        </button>
                    </div>
