    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                <form class="login100-form validate-form" action="{{ route('web_reset_password') }}" target="_self"
                      method="POST">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" type="text" name="newpass" placeholder="رمز عبور جدید">
                    ...
                    <div class="container-login100-form-btn m-t-20">
                        <button class="login100-form-btn" type="submit" style="background: #bd2130;">
                            تایید
                        </button>
                    </div>
